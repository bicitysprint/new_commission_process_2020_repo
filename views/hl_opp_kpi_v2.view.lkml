view: hl_opp_kpi_v2 {
  ...
  dimension: conversion_check {
    type: string
    sql: ${TABLE}."CONVERSION_CHECK" ;;
  }

  dimension: converted_opp_id {
    type: string
    sql: ${TABLE}."CONVERTED_OPP_ID" ;;
  }
